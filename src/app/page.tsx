        ...
        <section className="relative overflow-hidden pt-12 pb-16 lg:pt-20 lg:pb-24 border-b border-slate-800/80">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 text-indigo-300 border border-indigo-500/30 text-xs font-mono font-bold shadow-lg shadow-indigo-500/10 animate-fade-in">
              ...
              <span>10 INTERACTIVE DASHBOARDS + UI LIBRARY</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Explore 10 pixel-perfect interactive dashboard templates built with Next.js, Tailwind CSS, Lucide icons, and custom animations — plus custom animated loaders and UI component galleries.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              ...
              >
                ...
                <span>Explore 10 Dashboards</span>
            ...
            <div className="pt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
                ...
                <div className="text-xs text-slate-400 font-medium">Dashboard Templates</div>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
                <div className="text-2xl font-black text-indigo-400">12+</div>
                <div className="text-xs text-slate-400 font-medium">Animated Loaders</div>
              </div>
              <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
              ...
              <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
                ...
                <div className="text-xs text-slate-400 font-medium">Coming Soon Categories</div>
              </div>
            </div>
